...
require_once '../Controller/PedidoProductoCatalogoController.php';
...
require_once '../Controller/RemitoProductoController.php';
...
(new PedidoProductoCatalogoController($app))->init();
...
(new RemitoProductoController($app))->init();
