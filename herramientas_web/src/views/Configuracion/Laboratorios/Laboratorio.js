                        ...
                        <Row>
                            <Col xs="12">
                                <FormGroup>
                                    ...
                                    <FormFeedback
                                        invalid={!validationState.laboratorio.codigo.pristine && !validationState.laboratorio.codigo.valid}>{validationState.laboratorio.codigo.message}</FormFeedback>
                                </FormGroup>
                            </Col>
                            <Col xs="10">
                                <FormGroup>
                                    ...
                                    <FormFeedback
                                        invalid={!validationState.laboratorio.descripcion.pristine && !validationState.laboratorio.descripcion.valid}>{validationState.laboratorio.descripcion.message}</FormFeedback>
                                </FormGroup>
                            </Col>
                            <Col xs="2">
                                <FormGroup>
