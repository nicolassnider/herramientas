...
import {
    getDeterminacionPorId,
    nuevaDeterminacion,
    editarDeterminacion
} from '../../../services/DeterminacionesServices';
                        ...
                        <Row>
                            <Col xs="12">
                                <FormGroup>
                                    ...
                                    <FormFeedback
                                        invalid={!validationState.determinacion.titulo.pristine && !validationState.determinacion.titulo.valid}>{validationState.determinacion.titulo.message}</FormFeedback>
                                </FormGroup>
                            </Col>
                            <Col xs="10">
                                <FormGroup>
