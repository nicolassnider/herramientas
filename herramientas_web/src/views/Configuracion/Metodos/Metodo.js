                    ...
                    <CardBody>
                        <Row>
                            ...
                            <Col xs="12">                                
                                ...
                                <FormFeedback invalid={!validationState.metodo.titulo.pristine && !validationState.metodo.titulo.valid}>{validationState.metodo.titulo.message}</FormFeedback>
                            </Col>
                            <Col xs="12">
                                ...
                                <FormFeedback invalid={!validationState.metodo.descripcion.pristine && !validationState.metodo.descripcion.valid}>{validationState.metodo.descripcion.message}</FormFeedback>
                            </Col>
                            <Col xs="12">
                                ...
                                <FormFeedback invalid={!validationState.metodo.instrucciones.pristine && !validationState.metodo.instrucciones.valid}>{validationState.metodo.instrucciones.message}</FormFeedback>
                            </Col>
                            ...
                            <Col xs="6">
                                ...
                                <FormFeedback invalid={!validationState.metodo.enteros.pristine && !validationState.metodo.enteros.valid}>{validationState.metodo.enteros.message}</FormFeedback>
                            </Col>                            
                            <Col xs="6">
                                ...
                                <FormFeedback invalid={!validationState.metodo.decimales.pristine && !validationState.metodo.decimales.valid}>{validationState.metodo.decimales.message}</FormFeedback>
                            </Col>                                                       
                            <Col xs="6">
                                ...
                                <FormFeedback invalid={!validationState.metodo.minimo.pristine && !validationState.metodo.minimo.valid}>{validationState.metodo.minimo.message}</FormFeedback>
                            </Col>
                            <Col xs="6">
                                ...
                                <FormFeedback invalid={!validationState.metodo.maximo.pristine && !validationState.metodo.maximo.valid}>{validationState.metodo.maximo.message}</FormFeedback>
                            </Col>            
                            <Col xs="12">
                                ...
                                <FormFeedback invalid={!validationState.metodo.multiplo.pristine && !validationState.metodo.multiplo.valid}>{validationState.metodo.multiplo.message}</FormFeedback>
                            </Col>                
                            <Col xs="6">
                                ...
                                <FormFeedback invalid={!validationState.metodo.cifrasSignificativas.pristine && !validationState.metodo.cifrasSignificativas.valid}>{validationState.metodo.cifrasSignificativas.message}</FormFeedback>
                            </Col>
                            <Col xs="6">
