                        ...
                        <Row>
                            <Col sm="6" xs="12">
                                <FormGroup>
                                    ...
                                    <FormFeedback invalid={!validationState.serie.cargaInicio.pristine && !validationState.serie.cargaInicio.valid}>{validationState.serie.cargaInicio.message}</FormFeedback>
                                </FormGroup>
                            </Col>
                            <Col sm="6" xs="12">
                                <FormGroup>
                                    ...
                                    <FormFeedback invalid={!validationState.serie.cargaFin.pristine && !validationState.serie.cargaFin.valid}>{validationState.serie.cargaFin.message}</FormFeedback>
                                </FormGroup>
                            </Col>
                            <Col sm="6" xs="12">
                                <FormGroup>
                                    ...
                                    <FormFeedback invalid={(!validationState.serie.envioMuestra.pristine && !validationState.serie.envioMuestra.valid).toString()}>{validationState.serie.envioMuestra.message}</FormFeedback>
                                </FormGroup>
                            </Col>
                            <Col sm="6" xs="12">
                                <FormGroup>
                                    ...
                                    <FormFeedback invalid={(!validationState.serie.laboratorio.id.pristine && !validationState.serie.laboratorio.id.valid).toString()}>{validationState.serie.laboratorio.id.message}</FormFeedback>
                                </FormGroup>
                            </Col>
                        </Row>
                        <Row>
