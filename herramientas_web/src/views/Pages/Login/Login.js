                                        ...
                                        <Form className="login" onSubmit={this.handleSubmit}>
                                            ...
                                            <InputGroup className="mb-4">
                                                ...
                                                <Input
                                                    ...
                                                    value={this.state.clave.value}
                                                    onChange={this.handleChangeClave}
                                                    valid={this.state.clave.isValid && this.state.clave.touched}
                                                    invalid={!this.state.clave.isValid && this.state.clave.touched}/>
                                                {/* <FormFeedback className="text-center">La contraseña es obligatoria</FormFeedback> */}
                                            </InputGroup>
                                            {this.state.tryLogin && this.state.loginError.length > 0 &&
                                            ...
                                            <Row>
                                                <Col md="4">
                                                    <Button
                                                        ...
                                                        type="submit"
                                                        disabled={!this.state.usuario.isValid || !this.state.clave.isValid}>Ingresar</Button>
                                                </Col>
                                                <Col md="8" className="text-right">
                                                    <Button color="link" className="px-0 btn-custom-block">Recordar
                                                        contraseña</Button>
                                                </Col>
                                            </Row>
                                        </Form>
