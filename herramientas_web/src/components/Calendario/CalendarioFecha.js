                    ...
                    <Row>
                        <Col lg={props.isActive && !props.forPresentacion ? "3" : "4"}>
                            <div className="callout callout-info">
                                ...
                                <div>
                                    <div
                                        className="text-value">{moment(props.serie.cargaInicio).format("DD/MM/YYYY")}</div>
                                </div>
                            </div>
                        </Col>
                        <Col lg={props.isActive && !props.forPresentacion ? "3" : "4"}>
                            <div className="callout callout-info">
                                ...
                                <div>
                                    <div
                                        className="text-value">{moment(props.serie.cargaFin).format("DD/MM/YYYY")}</div>
                                </div>
                            </div>
                        </Col>
                        <Col lg={props.isActive && !props.forPresentacion ? "3" : "4"}>
                            <div className="callout callout-info">
                                ...
                                <div>
                                    <div
                                        className="text-value">{moment(props.serie.envioMuestra).format("DD/MM/YYYY")}</div>
                                </div>
                            </div>
                        </Col>
                        {
