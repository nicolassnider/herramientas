			...
			this.table = $(this.refs.grid).DataTable(
              ...
              switch (cellData) {
                case true:
                  ...
                  $(td).attr('title', 'ACTIVO');
                  break;
                case false:
                  $(td).addClass('status-red');
                  $(td).attr('title', 'INACTIVO');
                  break;
                default:
                  ...
                  break;
						...
						name: 'realizarALosKms',
						title: 'Realizar',
						className: 'all',
						data: 'realizarALosKms',
						filterType: 'input'
					}, {
						...
						data: 'servicio',
						render: function(data, type, row) {
							return data && data.preventivoCadaKms ? data.preventivoCadaKms : '';
						},
						filterType: 'input'
					}, {
						...
						data: 'servicio',
						render: function(data, type, row) {
							return data && data.preventivoAlertarKmsPrevios ? data.preventivoAlertarKmsPrevios : '';
						},
						filterType: 'input'
					}, {
						title: 'Km Actual',
						...
						data: 'movil',
						render: function(data, type, row) {
							return data && data.kmActual ? data.kmActual : '';
						},
						filterType: 'input'
					}, {
						orderable: false,
						...
						render: function(data, type, full, meta) {
							let html =
								...
								(Security.hasPermission('PREVENTIVOS_MODIFICAR') ? `
								...
								(Security.hasPermission('PREVENTIVOS_ELIMINAR') ? `
...
export default PreventivosGrid;