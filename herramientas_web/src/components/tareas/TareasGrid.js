...
class TareasGrid extends Component {
	constructor(props) {
		super(props);
        this.dataService = '/tareas/grid';
			    					...
			    					<table id="dataTable" className="table nowrap server-side table-hover" ref="grid" width="100%">
											<tfoot>
												<tr style={{backgroundColor: '#fff'}}>
													...
													<th className=""></th>
													<th className="p-0"></th>
													<th className="dt-search-header">Tarea</th>
													<th className="dt-search-header">Servicio</th>
