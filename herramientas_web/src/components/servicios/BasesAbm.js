...
class BasesAbm extends Component {
  ...
  handlePaisChange(name, object) {
    Promise.all([
      ...
      this.ajaxHandler.getJson('/provincias/' + object.id + '/select')
		]).then((data) => {
  ...
  handleLocalidadChange(name, localidad) {
    const value = localidad === null ? null : localidad.value;
                        ...
                        <div className="col-md-6">
                          ...
                          <div  className="form-group row"> 
                            ...
                            <Select
                                  ...
                                  labelKey='label'                                 
                                  value={formData.jefe}
                                  onChange={(e) => this.handlePersonaFormChange("jefe", e)}
                                />
                        ...
                        <div className="col-md-6">
                          ...
                          <div  className="form-group row"> 
                            ...
                            <Select
                                  ...
                                  onChange={(e) => this.handlePersonaFormChange("responsable", e)}
                                />
                              ...
                              <div className="col-md-9">
                                ...
                                <div>
                                  <Select
                                    ...
                                    onChange={(e) => this.handleProvinciaChange("provincia", e)}
                                  />
                              ...
                              <div className="col-md-9">
                                ...
                                <div>
                                  <Select
                                    ...
                                    onChange={(e) => this.handleLocalidadChange("localidad", e)}
                                  />
