...
class CentrosCostosGrid extends Component {
	constructor(props) {
		super(props);
        this.dataService = '/centros-costos/grid';
				...
				columns: [
					...
					drawCallback: function () {
						$(this).find('.action').on('click', function () {
							...
							.then((isConfirm) => {
								if (isConfirm) {
									fetch(Config.get('apiUrlBase') + '/centros-costos/' + data.id, {
										method: 'DELETE',
										headers: {
...
export default CentrosCostosGrid;
