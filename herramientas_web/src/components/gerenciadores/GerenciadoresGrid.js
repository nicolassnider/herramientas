...
class GerenciadoresGrid extends Component {
	constructor(props) {
		super(props);
        this.dataService = '/gerenciadores/grid';
				...
				columns: [
					{
						...
						render: function (data, type, row) {
							return '<div class="dt-user-avatar">'+row.razonSocial.substr(0,1)+'</div>';
						},
						filterType: 'none'
					},{
					...
					drawCallback: function () {
						$(this).find('.action').on('click', function () {
							...
							.then((isConfirm) => {
								if (isConfirm) {
									fetch(Config.get('apiUrlBase') + '/gerenciadores/' + data.id, {
										method: 'DELETE',
										headers: {
							...
							.prepend(`<div class="container">
													...
													<div class="row mb-2">
														<div class="col-12" style="border-bottom: 1px solid #000;">
															<h2>Listado de Gerenciadores</h2>
														</div>
													</div>
												</div>`);
			    					...
			    					<table id="dataTable" className="table nowrap server-side table-hover" ref="grid" width="100%">
											<tfoot>
												<tr style={{backgroundColor: '#fff'}}>
													...
													<th className=""></th>
													<th className="p-0"></th>
													<th className="dt-search-header">Gerenciador</th>
													<th className="dt-search-header">Tipo</th>
													<th className="dt-search-header">Contacto</th>
													<th className="dt-search-header">Teléfono</th>
													<th className="dt-search-header">Email</th>
													<th className=""></th>
												</tr>
											</tfoot>
										</table>
...
export default GerenciadoresGrid;
