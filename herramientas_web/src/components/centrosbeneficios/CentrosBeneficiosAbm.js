...
class CentrosBeneficiosAbm extends Component {
	constructor(props) {
		super(props);
    ...
    let component = this;
      ...
      this.state.props.action !== 'ADD' ? this.getData('centros-beneficios', this.state.props.match.params.id) : null  
		]).then((data) => {
  ...
  handlePaisChange(name, object) {
    ...
    this.setState({ loading: true });
		let component = this
		fetch(Config.get('apiUrlBase') + '/centros-beneficios' + (this.props.action === 'ADD' ? '' : '/' + this.state.formData.id), {
                        ...
                        <div className="col-md-6">
                          <div className="form-group row">
                            ...
                            <div className="col-md-9">
                              ...
                              <div>
                                <input type="text" className="form-control" id="nombre" name="nombre" placeholder="Centro de Beneficio" value={formData.nombre} onChange={this.handleInputFormChange} />   
...
export default CentrosBeneficiosAbm;